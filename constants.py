...
BRAWLER_ROSTER = {
    ...
    "Shade": ["Assassin"], "Shelly": ["Anti-Tank"], "Sirius": ["Thrower"], 
    "Spike": ["DPS"], "Sprout": ["Thrower"], "Squeak": ["Controller"], 
    "Stu": ["Assassin"], "Surge": ["Anti-Tank"], "Tara": ["Anti-Tank"], 
    "Tick": ["Thrower"], "Trunk": ["Tank"], "Willow": ["Thrower"], "Ziggy": ["Thrower"],
}
...
CLASS_BASE_WEIGHTS = {
    ...
    "Controller": {"kills": 1.10, "dps": 1.30},
